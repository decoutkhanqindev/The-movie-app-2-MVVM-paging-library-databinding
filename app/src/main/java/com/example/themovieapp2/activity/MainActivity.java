...
public class MainActivity extends AppCompatActivity {
    ...
    ActivityMainBinding mainBinding; // la 1 bien dc tao ra boi Databinding dc su dung de truy cap
    ...
    private void initRecyclerviewAndAdapter() {
        ...
        mainBinding.recyclerview.addItemDecoration(new GridSpace(2, 20, true));
        ...
        gridLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
            ...
            public int getSpanSize(int position) {
                return moviesPagingAdapter.getItemViewType(position) == MoviesPagingAdapter.LOAD_ITEM ? 1 : 2;
            }
        });
    }
}